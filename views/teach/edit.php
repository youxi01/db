...
<form class="form-horizontal"  id="form" role="form" action="<?= Url::to(['save'])?>" method="post" enctype="multipart/form-data" target="supportiframe">
 <input type="hidden" name="id" value="<?php echo $teach_data['id'];?>">
  <input type="hidden"
		...
		<div class="ibox-content add_body" id="add_body" >
			<div class="row">
					...
					<div class="full-height-scroll">
						<div class="row">
                         ...
                         <div class="form-group">
									...
									<div class="col-md-2">
                                    <?php if($teach_data['small_img']){?>
										<a href="<?php echo Yii::$app->params['CLASS_URL']?><?php echo $teach_data['small_img']?>" target="_blank"><img id="main_pic_prev" class="thumb80" src="<?php echo Yii::$app->params['CLASS_URL']?><?php echo $teach_data['small_img']?>" /></a>
                                        <?php
									}else{
										?>
									...
									<div class="col-md-7">
										<input class="form-control" aria-required="true" type="text" id="title" name="title" value="<?php echo $teach_data['title'];?>"/>
									</div>
									<div class="col-md-2"><span style="color:red;line-height: 32px;margin-left: 0px;">*</span></div>
                                       ...
                                       <div class="form-group">
										<label class="col-md-3 control-label">发布<?=Yii::$app->params['lang_train_campus']?>：</label>
										<div class="col-md-7">
				...
				$campus_id_arr=explode(',',$teach_data['campus_id']);
            ...
            <div class="checkbox checkbox-primary pull-left">
													<input name="campus[]" class="check_list"  type="checkbox" value="<?php echo $rs['id']?>"  id='campus_<?php echo $rs['id']?>' <?php if (in_array($rs['id'],$campus_id_arr)) echo 'checked';?> />
				...
				?>             
                          ...
                          <div class="form-group">
									<label class="col-md-3 control-label">是否置顶：</label>
																			<div class="col-md-7">
										 <div class='radio radio-info radio-inline'><input name='is_top' type='radio' id='is_top_1' value='0' <?php if($teach_data['is_top']==0) echo 'checked';?>/><label for='is_top_1'>否</label></div> &nbsp; <div class='radio radio-info radio-inline'><input type='radio' name='is_top' id='is_top_2' value='1' <?php if($teach_data['is_top']==1) echo 'checked';?>/><label for='is_top_2'>是</label></div>										</div>
                              ...
                              <div class="form-group">
									<label class="col-md-3 control-label">首页推荐：</label>
																			<div class="col-md-7">
			    <div class='radio radio-info radio-inline'><input name='is_ad' type='radio' id='is_ad_1' value='0' <?php if($teach_data['is_ad']==0) echo 'checked';?>/><label for='is_ad_1'>否</label></div> &nbsp; <div class='radio radio-info radio-inline'><input type='radio' name='is_ad' id='is_ad_2' value='1' <?php if($teach_data['is_ad']==1) echo 'checked';?>/><label for='is_ad_2'>是</label></div>										</div>
										<div class="col-md-2"></div>
							  </div>                                      
                               ...
                               <div class="form-group">
									...
									<div class="col-md-7">
									  <input class="form-control" aria-required="true" type="text" id="tel" name="tel" value="<?php echo $teach_data['tel']?>"/>
									</div>
									<div class="col-md-2"><span style="color:red;line-height: 32px;margin-left: 0px;"></span></div>
							  </div>   
                          ...
                          <div class="form-group">
									...
									<div class="col-md-9">
										<textarea id="content" name="content" style="width:650px;height:300px; border:1px solid #ddd;visibility:hidden;"><?php echo $teach_data['f_contents'];?></textarea>  <script>
      var editor;
